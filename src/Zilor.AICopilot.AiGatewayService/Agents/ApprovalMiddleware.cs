...
public class ApprovalMiddleware
{
    ...
    private readonly ILogger<ApprovalMiddleware> _logger;
    ...
    public ApprovalMiddleware(AgentPluginLoader pluginLoader,
        ...
        CancellationToken cancellationToken)
    {
        ...
        _logger.LogInformation("开始检查函数调用：{Plugin}.{Function}", pluginName, functionName);
        ...
        {
            _logger.LogWarning("拦截到高风险操作：{Plugin}.{Function}, CallId: {Id}",
